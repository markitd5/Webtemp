<template>
  <v-container fluid>
    <v-row justify="center" class="my-5">
      ...
      <v-col cols="12" md="8">
        <v-card class="pa-5 elevation-10" style="border-radius: 20px; background-color: azure;" hover outlined>
          ...
          <v-card-text>
            <v-row>
              <!-- อุณหภูมิ -->
              <v-col cols="12" sm="6">
                <v-card style="border-radius: 20px; background-color: #ffe0e0;" class="pa-3 elevation-5" hover outlined>
              ...
              <!-- ความชื้น -->
              <v-col cols="12" sm="6">
                <v-card style="border-radius: 20px; background-color: #e0f7fa;" class="pa-3 elevation-5" hover outlined>
            ...
            <v-row class="mt-5">
              <!-- อุณหภูมิที่เหมาะสม -->
              <v-col cols="12" sm="6">
                <v-card style="border-radius: 20px; background-color: #fff9c4;" class="pa-3 elevation-5" hover outlined>
              ...
              <!-- ความชื้นที่เหมาะสม -->
              <v-col cols="12" sm="6">
                <v-card style="border-radius: 20px; background-color: #c8e6c9;" class="pa-3 elevation-5" hover outlined>
    ...
    <v-row justify="center" class="my-5">
      <!-- Control Card -->
      <v-col cols="12" md="8">
        <v-card style="border-radius: 20px; background-color: #f3e5f5;" class="pa-5 elevation-10" hover outlined>
          <v-row justify="space-around" class="mb-5">
            <v-col cols="12" sm="5">
              <v-btn block color="green darken-2" class="white--text" large @click="start" style="border-radius: 20px; height: 50px;">
                เปิด
              </v-btn>
            </v-col>
            <v-col cols="12" sm="5">
              <v-btn block color="red darken-2" class="white--text" large @click="stop" style="border-radius: 20px; height: 50px;">
                ปิด
              </v-btn>
            </v-col>
          </v-row>
          ...
          <v-card-text>
            <v-row class="justify-center">
              <v-col cols="3" class="text-center">
                <v-icon :color="isOn ? 'green darken-2' : 'grey'" style="font-size: 48px;">
                  mdi-lightbulb-on
                </v-icon>
                <div>ON</div>
              </v-col>
              <v-col cols="2" class="text-center">
                <v-icon :color="numericValueState() === 1 || numericValueState() === 4 || numericValueState() === 5 ? 'red darken-2' : 'grey'" style="font-size: 38px;">
                  mdi-lightbulb
                </v-icon>
              </v-col>
              <v-col cols="2" class="text-center">
                <v-icon :color="numericValueState() === 2 || numericValueState() === 4 || numericValueState() === 5 ? 'green darken-2' : 'grey'" style="font-size: 38px;">
                  mdi-lightbulb
                </v-icon>
              </v-col>
              <v-col cols="2" class="text-center">
                <v-icon :color="numericValueState() === 3 || numericValueState() === 5 ? 'blue darken-2' : 'grey'" style="font-size: 38px;">
                  mdi-lightbulb
                </v-icon>
              </v-col>
              <v-col cols="3" class="text-center">
                <v-icon :color="!isOn ? 'red darken-2' : 'grey'" style="font-size: 48px;">
                  mdi-lightbulb
                </v-icon>
                <div>OFF</div>
              </v-col>
            ...
            <v-row class="justify-center">
              <v-col cols="6" class="text-center">
                <v-icon :color="temperatureStatus() === 'cold' ||  temperatureStatus() === 'quite cold' ? 'green darken-2' : 'grey'" style="font-size: 48px;">mdi-air-conditioner</v-icon>
                <div>เครื่องปรับความร้อน</div>
              </v-col>
              <v-col cols="6" class="text-center">
                <v-icon :color="humidityStatus() === 'hot' ||  humidityStatus() === 'quite hot' ? 'green darken-2' : 'grey'" style="font-size: 48px;">mdi-water</v-icon>
